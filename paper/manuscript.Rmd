...
It also allows us to quantify a species' control capacity—its relative importance—and identify the set of species that, collectively, are critical—have maximum control capacity—in this context. 
...
See Supporting Information Section \@ref(S-visitation-as-proxy) for more details. 
...
First, structural controllability emphasizes that the effect a species has on the abundance of other species is not independent of the effects of those other species in their community. 
...
Invasive plants tended to be important for network persistence, be abundant, and depend little on other species and, as a result, have high control capacity, just like any other mutualist in our data set with those properties.
