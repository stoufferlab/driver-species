...
```{r fig-species-partial, fig.width=fig_sizes()[[2]], fig.height=fig_sizes()[[1]]/2, fig.cap= "Partial-residual plots for the relationship between control capacity and the independent variables: (a) contribution to nestedness, (b) visitation strength, (c) asymmetry of dependences, and (d) degree. Partial residual plots show the relationship between the response and each of the independent variables given that all other independent variables have been accounted for. Ploted values correpond to the predictions of the weighted average of the models shown in Table \\@ref(tab:tab-model-selection-table)"}
