...
On one hand, substantive changes in ecosystem functioning can also occur without complete removal of a species [@mouillot_functional_2013; @daniel_has_ideas]. 
...
When the state of a community is underpinned by more than a single species and we move beyond single-species removals, we might expect the accuracy of centrality to diminish.
<!-- DBS: We could potentially cut the sentence above; I see the merit, but I also feel like it could annoy readers/reviewers. -->
<!-- FDO: I made the sentence softer, do you think it's good enough? I'm happy to remove it alltogether though -->
...
Species abundances---and consequently the state of the community as a whole---are influenced by both their interactions, the specific dynamics of these interactions and the mechanisms of self-regulation [@lever_sudden_2014]. 
...
<!-- FDO: Changed to stable coexistence, so maybe we can get by without further introduction -->
Finally, we compare the proposed approach to current methods based on species centrality and show how these methods are indeed valuable but ultimately paint a limited picture in regards to the "keystoneness" of a species.
<!-- DBS: Is "supporting the diversity" the right function to call out at this point? -->
<!-- FDO: Removed that part of the sentence. I think it's fine without it -->
