...
To solve this problem, we employ a recently-developed algorithm that reveals the control correlations between the nodes in the graph [@zhang_input_2016, Supplementary Information section \@ref(S-input-graph)]. 
Using this algorithm, we are able to obtain every minimum driver node set with information obtained from a single maximum matching. <!-- I don't think I follow the end of this sentence. -->
