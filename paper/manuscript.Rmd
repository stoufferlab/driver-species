...
To do that we compared the results obtained using visitation to two alternative metric in a dataset that lacked invasive species [@ballantyne_constructing_2015]. 
