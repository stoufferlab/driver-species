...
```{r fig-emp-controllability, fig.width=fig_sizes()[[1]], fig.height=fig_sizes()[[1]]/sqrt(2), fig.cap="Density plot ofsize of the minimum driver node set. The vertical dashed line indicates the meann value."}
