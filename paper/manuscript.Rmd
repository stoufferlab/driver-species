...
Sometimes, however, there is no assymetry in the dependences between species pairs ($d_{ij}=d_{ji}$), and we cannot infer the direction of control. 
As such, we deem both species to be equally likely to affect each other and create two directed links between them, one from *i* to *j* and another from *j* to *i*. 
