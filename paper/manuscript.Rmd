...
\R{R2-random-effects}We initially included random effects to account for possible variation across communities, but we found that the among-group variance was effectively zero, and therefore random effects were not included in further analyses. 
