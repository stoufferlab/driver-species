...
In complex systems, however, employing this rank condition, or numerical approximations of it, is unfeasible because it is hard to fully parameterize *A* and *B*. 
...
Such approach is typically unpractical so we are interested in finding a minimum driver node set (effectively finding *B*) with which to make the system contr



Controllability is this
But is hard to calculate.
Therefore we use recent advances that show that it can be calculated using maximum matching algorithms. 
