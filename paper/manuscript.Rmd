...
* **Number of words:** 148 abstract; approx. 5,006 main text.
...
The trade-off is that, because of the assumption that ecological communities can be modelled with linear functional responses, structural controllability is not sufficient to fully design a the time-varying control signal *u(t)* that can drive the system from one particular equilibrium to another. 
