...
In addition, a graphical interpretation of the structural controllability theorem enables us to translate the control problem into a topological one: a network is controllable if there are no inaccessible nodes—nodes without incoming links—or dilations—*expansions* of the network (see supplementary information section  \@ref(S-structural-controllability) for more details).
