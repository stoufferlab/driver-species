...
* **Number of words:** 148 abstract; approx. 5278 main text.
...
Finally, we calculated the average rank (akin to a p-value) of *n~D~* for each empirical network compared to the corresponding values of each set of 999 randomisations [@Veech2012].
...
Candidate models and estimates were assessed using the same procedure as in the  models for *n~D~*.
