...
The minimum number of species necessary to control this network equates to the number of unmatched nodes $n_d = 2$, which gives an overall manageability of $m = 0.8$.
...
A scaled mean rank—akin to a p-value— less than 0.025 or greater than 0.975 (the areas shaded in light grey) suggests a significant difference between the empirical network and its randomisations. 
