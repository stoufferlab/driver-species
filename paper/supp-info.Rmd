...
To simplify the calculations we assumed that there is no mutualistic trade-off, and a mean field interspecific competition of $\rho = 0.005$ [@saavedra_nested_2016]. 
