...
To simplify the calculations we assummed that there is no mutualistic trade off, and a mean field interspecific competition of $\rho = 0.01$ [@saavedra_nested_2016]. 
...
```{r fig-rho-sensitivity, fig.width=fig_sizes()[[2]], fig.height=fig_sizes()[[1]]/2, fig.cap="Spearman correlation coefficient of the contribution to stable coexistence of species. Grey lines indicate the correlation coeficient for each of the twenty empirical networks. The solid black line indicates the median value."}
