...
```{r fig-superior, fig.width=fig_sizes()[[2]], fig.height=fig_sizes()[[1]]/2, fig.cap = "Relationship between the most important variables in the models of superior probability. The plots show the values predicted by most parsimonious model. Invasive species are depicted with solid orange circles."}
