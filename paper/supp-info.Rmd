...
For simplicity, in the main text we show results for when there was no mutualistic trade-off $\delta = 0$ and an intermediate value of interspecific competition of $\rho = `r drake::readd(chosen_rho)`$ [@saavedra_nested_2016]. 
