...
Our previous conclusion arose from a trivial mistake on the interpretation of this result for which we are apologetic. 
This regression indicates that the invasion status is *inversely* related to $n_D$ (the density of driver nodes) and **not** to our previous definition of manageability $m = 1- n_D$. 
