...
```{r fig-f-s-rankings, echo = F, message = F, warning = F, fig.width = 6.2, fig.height = 9, results = "hide", fig.cap="**Frequency with which a species was classified as a superior node ($f_S$) as a function of the matching weight threshold**. Rows correspond to network pairs.", cache = T}
...
```{r fig-f-d-rankings, echo = F, message = F, warning = F, fig.width = 6.2, fig.height = 9, results = "hide", fig.cap= "**Frequency with which a species was classified as a driver node ($f_D$) as a function of the matching weight threshold**. Rows correspond to network pairs.", cache = T}
