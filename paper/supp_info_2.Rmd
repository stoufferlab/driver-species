...
In addition, here we also show all the maximum cardinality matchings for an example network in which the links are bidirectional (Supporting Figure 4). It is important to note that using bidirectional is problematic for a couple 
