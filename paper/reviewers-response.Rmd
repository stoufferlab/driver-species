...
We have checked through the manuscript and corrected this where relevant. 
...
We have made this clearer as follows: "and included every invasive species in our dataset" (\lr{R2-our-dataset})
...
We now identify the distinction between high control capacity and being critical on lines \lr{R2-define-control-capacity} "It also allows us to quantify a species control capacity-its relative importance-and identify the set of species that, collectively, are critical-have maximum control capacity-in this context."


> L27: unclear what "its" refers  to

We now explicitly state "species' degree" \lr{R2-species-degree}

> L111, 114: "are comprised of" should be "comprised "

Thank you, we have corrected this.

> L234, 235: awkward to refer to species as "they" and "their "

We have changed this to "it" and "its"

> L296: "More details in Supporting Information ."  is a sentence fragment.

We have corrected this on line \lr{R2-sentence-fragment}

> L339, 432: "at" should be "in" 

Thank you, this has been corrected.

> L341: "allow" should be "allowed "
...
We now introduce table 2 on line \lr{R2-ref-glossary}.

>L355: missing period 

Thank you for noticing this, we have inserted the missing period.


# Reviewer comments #1

> "I'd like to commend the authors to this revised version of the manuscript on "Keystoneness, centrality, and the structural controllability of ecological networks". I thoroughly enjoyed the re-written manuscript, which is now considerably more accessible and clearly targets the community of network ecologists, while not ignoring the importance of the applied relevance of the findings. Overall, I don't have any major comments. I guess the language is in parts on the casual side, yet without compromising the preciseness or clarity of the text. I noticed a few typos or style errors that the authors may want to address"

We are pleased that the reviewer "thoroughly enjoyed the re-written manuscript", and appreciate the identified issues. We have addressed all issues in the text and identify these in red.  


> A few references require editing to journal style (e.g. remove initials for many citations)

We have corrected all of them except on \lr{R2-citation-with-name} where the initial is used to distinguis between two authors with the same last name

>L314. open bracket missing .

Thank you for pointing this out, we have inserted the missing bracket.

> L358. change 'instead' to 'Instead'. L381. remove second comma 
...
We have removed the second 'other'. We have rewritten the sentence on line \lr{R2-structural-controllability} to improve clarity. It now reads as follows: "First, structural controllability emphasizes that the effect a species has on the abundance of other species is not independent of the effects of those other species in their community".

> Reference list needs updating, e.g. Ne'eman et al. is not 2009 but 2010. 

> Fig. S6 header of plot b). correct spelling of 'critical' 

> Congratulations on this thought-provoking methodological synthesis.
